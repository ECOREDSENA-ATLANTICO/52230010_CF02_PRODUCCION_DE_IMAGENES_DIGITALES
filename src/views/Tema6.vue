  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .row.justify-content-center.align-items-center.mb-5
        ...
        .col-lg-6
          .cajon.color-primario.p-4.mb-4.fnd-1
            p Las nuevas tendencias en marketing de guerrilla están marcadas por la creatividad disruptiva y la integración digital. Las personas que están diseñando estrategias digitales están utilizando el entorno urbano de manera innovadora, implementando instalaciones interactivas y eventos sorpresa que transforman espacios comunes en experiencias memorables. Esta técnica aprovecha el impacto visual y emocional para captar la atención de manera inesperada, generando así un mayor lealtad y compromiso con las audiencias.
          p Además, la combinación de marketing de guerrilla con estrategias digitales, como las redes sociales y el contenido viral, amplifica el alcance de las campañas. Las acciones físicas se documentan y comparten en línea, creando un efecto multiplicador que atrae la atención de una audiencia global. Esta fusión de tácticas no solo maximiza la visibilidad, sino que también refuerza el vínculo emocional entre la marca y los consumidores.
    ...
    .bloque-texto-g.color-primario.p-3.p-sm-4.p-md-5.mb-5(data-aos="fade-right")
      ...
      .bloque-texto-g__texto.p-4
        p Otro ejemplo creativo donde se utilizó marketing de guerrilla fue una campaña cuyo objetivo es generar conciencia sobre la contaminación, se situaron plásticos gigantes sobre esculturas en la ciudad, logrando la atención de la audiencia.           
    ...
    .fondo.fn-1
      .row.justify-content-center.align-items-center.mb-5
        ...
        .col-lg-9
          p Además, para establecer una estrategia de marketing de guerrilla, primero es vital definir un segmento de mercado y un lugar puntual donde ejecutar la táctica; también debe ser muy creativo y captar la atención de los líderes de opinión; por otro lado, integrar al espectador en el drama o performance de la estrategia de marketing; combinar herramientas como celulares, internet y escenografías; finalmente realiza el seguimiento del impacto de la estrategia. 
    ...
    .cajon.color-primario.p-4.mb-4.fnd-1
      p.mb-0 Por otro lado, los medios no convencionales, como ferias, exposiciones, performances y videojuegos promocionales, son utilizados para generar una mayor interacción con el público. Estas tácticas, comúnmente empleadas en campañas BTL (<em>Below The Line</em>), buscan sorprender al consumidor y establecer un vínculo emocional más profundo con la marca. El <em>marketing</em> de guerrilla, por ejemplo, es una estrategia eficaz que utiliza la sorpresa y la creatividad para captar la atención en lugares estratégicos, transformando la experiencia del consumidor en algo único e impactante.
